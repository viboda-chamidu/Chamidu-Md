...
SESSION_ID: process.env.SESSION_ID === undefined ? '崇数遂逗-酔帥=Y3khTIDD#8aF5Dk_6WDmUywh61n_LDDlrLA77FcbK6_-7FcM1Ggw' : process.env.SESSION_ID,
...
POSTGRESQL_URL: process.env.POSTGRESQL_URL === undefined ? 'postgresql://sadiya:MTCV3kmoO4YSt6bcK8naY9WCRRO7wL2v@dpg-d07n7k2li9vc73ff97bg-a/viboda_chamidu_db' : process.env.POSTGRESQL_URL,
FOOTER: process.env.FOOTER === undefined ? 'created by viboda chamidu' : process.env.FOOTER,
};
